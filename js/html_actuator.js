...
HTMLActuator.prototype.addTile = function(tile) {
    if (english) {
        var valueMap = {
            ...
            2048: ['gaze ', 'amaze ', 'daze ', 'maze ', 'blaze ', 'phase '],
            4096: ['frame ', 'game ', 'lame ', 'shame ', 'tame ', 'dame ']
        }
    } else {
        var valueMap = {
            2: ['नहीं ', 'कहीं ', 'वहीं ', 'कभी ', 'यूहीं ', 'सही '],
            4: ['भेंट ', 'सेठ ', 'ठेठ ', 'पेट ', 'समेत ', 'फेंट '],
            8: ['बीच ', 'खींच ', 'सींच ', 'मीच ', 'रीछ ', 'भींच '],
            16: ['नमकीन ', 'संकीर्ण ', 'गमगीन ', 'नाजनीन ', 'संगीन ', 'हक़ीम '],
            32: ['समय ', 'प्रलय ', 'सुजय ', 'सुजय ', 'अभय ', 'तनमय '],
            64: ['बंधन ', 'नन्दन ', 'सघन ', 'स्पन्दन ', 'स्वप्न', 'क्रंदन'],
            128: ['चैन ', 'नैन ', 'बैन ', 'रैन ', 'बेचैन ', 'अभिनय '],
            256: ['कुरान ', 'इंसान ', 'हैरान ', 'आसान ', 'पहचान ', 'अंजान '],
            512: ['दुखाना ', 'बुलाना ', 'बहलाना ', 'बहकना ', 'बहकाना ', 'बहाना '],
            1024: ['कासा ', 'साया ', 'चेहरा ', 'धोखा ', 'पहरा ', 'तिनका '],
            2048: ['भक्त ', 'व्यक्त ', 'अभिव्यक्त ', 'सख़्त ', 'तख़्त ', 'अशक्त '],
            4096: ['नाम  ', 'बदनाम ', 'हराम ', 'काम ', 'कलाम ', 'शाम ']
        }
    }
